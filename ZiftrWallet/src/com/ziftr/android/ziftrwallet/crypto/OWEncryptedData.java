...
public class OWEncryptedData {
     ...
     */
    public OWEncryptedData(OWEncryptedData encryptedPrivateKey) {
     ...
     */
    public OWEncryptedData(String encryptedData) {
    	this.encryptedData = encryptedData;
    }

    @Override
    public OWEncryptedData clone() {
        return new OWEncryptedData(this.encryptedData);
    }
    ...
    public boolean equals(Object obj) {
        ...
        final OWEncryptedData other = (OWEncryptedData) obj;
