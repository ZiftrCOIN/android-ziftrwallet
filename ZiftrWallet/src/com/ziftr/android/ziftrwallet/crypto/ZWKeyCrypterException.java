 ...
 */
public class ZWKeyCrypterException extends RuntimeException {
    private static final long serialVersionUID = -4441989608332681377L;

    public ZWKeyCrypterException(String s) {
        super(s);
    }

    public ZWKeyCrypterException(String s, Throwable throwable) {
        super(s, throwable);
    }
}
