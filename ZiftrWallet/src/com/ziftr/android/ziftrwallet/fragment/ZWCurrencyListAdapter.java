...
public class ZWCurrencyListAdapter extends ArrayAdapter<ZWCoin> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		SpannableString displayMarketFiat = fiatType.getDisplayString(unitPriceInFiat, true, coin.getFiatEquivPrecision());
		...
		SpannableString displayWalletTotalFiat = fiatType.getDisplayString(ZWConverter.convert(amount, coin, fiatType), true, coin.getFiatEquivPrecision());
