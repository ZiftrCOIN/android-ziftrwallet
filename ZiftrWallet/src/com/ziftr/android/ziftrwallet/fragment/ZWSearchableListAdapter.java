...
public abstract class ZWSearchableListAdapter<T extends ZWSearchableListItem> extends BaseAdapter implements Filterable {
	...
	public ZWSearchableListAdapter(Context ctx, int resource, List<T> txList) {
