...
public class OWSQLiteOpenHelper extends SQLiteOpenHelper {
	 ...
	 */
	public synchronized List<OWAddress> readAllVisibleAddresses(OWCoin coinId, boolean receivingNotSending) {
	 ...
	 * @param coinId - The coin type to determine which table we use. 
	 */
	public List<OWAddress> readAllVisibleAddresses(OWCoin coinId) {
		List<OWAddress> addresses = this.readAllVisibleAddresses(coinId, false);
