...
public class OWPbeAesCrypter implements OWKeyCrypter {
	...
	public OWPbeAesCrypter(SecretKey secretKey) {
	...
	public OWEncryptedData encrypt(String clearText) throws OWKeyCrypterException {
		try {
			...
			return new OWEncryptedData(ivHex + encryptedHex);
		} catch (Exception e) {
			System.out.println("error message: " + e.getMessage());
			throw new OWKeyCrypterException("Unable to encrypt", e);
		}
	}
	...
	public String decrypt(OWEncryptedData encryptedData) throws OWKeyCrypterException {
		try {
			...
			throw new OWKeyCrypterException("Unable to decrypt", e);
		}
	}
	...
	public static SecretKey generateSecretKey(String password, String salt) throws OWKeyCrypterException {
		try {
			...
			throw new OWKeyCrypterException("Unable to get secret key", e);
		}
	}

	@SuppressLint("TrulyRandom") // Have applied the fix
	public static String generateSalt() throws OWKeyCrypterException {
		try {
			...
			throw new OWKeyCrypterException("Unable to generate salt", e);
		}
	}
	...
	public static void main(String[] args) {
		try {
			...
			OWKeyCrypter c = new OWPbeAesCrypter(secKey);

			String unencrypted = "E9873D79C6D87DC0FB6A5778633389F4453213303DA61F20BD67FC233AA33262";
			OWEncryptedData encrypted = c.encrypt(unencrypted);
